 ...
 */
package com.alibaba.cloud.mtls.ssl.socket;
 ...
 * Instead use the {@link com.alibaba.cloud.mtls.ssl.util.SSLSocketUtils SSLSocketUtils} which provides the same functionality
