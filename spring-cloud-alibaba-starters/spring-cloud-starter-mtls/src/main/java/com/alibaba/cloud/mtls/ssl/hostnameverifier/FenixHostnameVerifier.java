 ...
 */
package com.alibaba.cloud.mtls.ssl.hostnameverifier;
...
import static com.alibaba.cloud.mtls.ssl.hostnameverifier.HostnameCommon.canParseAsIpAddress;
import static com.alibaba.cloud.mtls.ssl.hostnameverifier.Hostnames.toCanonicalHost;

/**
 * <strong>NOTE:</strong>
 * Please don't use this class directly as it is part of the internal API. Class name and methods can be changed any time.
 * Instead use the {@link com.alibaba.cloud.mtls.ssl.util.HostnameVerifierUtils HostnameVerifierUtils} which provides the same functionality
